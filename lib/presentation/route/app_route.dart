...
import 'package:ibeauty/presentation/pages/auth/login_screen.dart';
import 'package:ibeauty/presentation/pages/auth/sign_up_field_screen.dart';
import 'package:ibeauty/presentation/pages/auth/sign_up_screen.dart';
    ...
    return AppHelper.showCustomModalBottomSheet(
      ...
      modal: BlocProvider.value(
        ...
        child: SignUpFieldScreen(
            colors: colors, isPhone: AppHelper.checkPhone(phone), phone: phone),
      ),
    );
  }
