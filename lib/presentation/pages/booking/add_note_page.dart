...
class _AddNotePageState extends State<AddNotePage> {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<BookingBloc>()
        ...
        ..add(BookingEvent.calculateBooking(
            startTime: widget.startTime, context: context));
    });
    super.initState();
  }
      ...
      children: [
        ...
        Row(
          children: [
            ...
            const Spacer(),
            Text(
              AppHelper.numberFormat(number: item?.price),
        ...
        ...?item?.extras?.map((e) => Padding(
              ...
              child: Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    AppHelper.numberFormat(number: e.price),
                    style: CustomStyle.interNormal(
  ...
  Widget _location(
      CustomColorSet colors, int? serviceId, MasterModel? masterModel) {
      ...
      builder: (context, stateCheckout) {
        return Padding(
          ...
          child: stateCheckout.address.isEmpty
              ? CustomButton(
                  title: AppHelper.getTrn(TrKeys.selectAddress),
