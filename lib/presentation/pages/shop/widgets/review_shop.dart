...
import 'package:ibeauty/presentation/style/theme/theme_wrapper.dart';
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      10.verticalSpace,
                      Text(
                        "${AppHelper.getTrn(TrKeys.basedOn)} ${state.shop?.ratingCount?.toStringAsFixed(0) ?? "0"} ${AppHelper.getTrn(TrKeys.reviews).toLowerCase()}",
