        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              gradient:  LinearGradient(
                colors: [
                  AppConstants.serviceColors[index%12],
                  AppConstants.serviceColors[index+1%12],
                ],
          ...
          child: Row(
            ...
            children: [
              SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "${AppHelper.getTrn(TrKeys.validFor)} ${myMembership.memberShip?.time ?? ""}",
                      style: CustomStyle.interRegular(
                          color: colors.textBlack, size: 14),
                      textAlign: TextAlign.right,
                      maxLines: 1,
              ...
              SizedBox(
                width: 64.r,
                child: Text(
                  AppHelper.numberFormat(number: myMembership.memberShip?.price),
                  style: CustomStyle.interNormal(
