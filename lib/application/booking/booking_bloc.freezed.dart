...
mixin _$BookingEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(BuildContext context, num totalPrice,
            DateTime startTime, ValueChanged<int> onSuccess)
        bookingService,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(BuildContext context, num totalPrice, DateTime startTime,
            ValueChanged<int> onSuccess)?
        bookingService,
    TResult? Function(BuildContext context, DateTime startTime)?
        calculateBooking,
...
class _$BookingServiceImpl implements BookingService {
  ...
  @override
  String toString() {
    return 'BookingEvent.bookingService(context: $context, totalPrice: $totalPrice, startTime: $startTime, onSuccess: $onSuccess)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, context, totalPrice, startTime, onSuccess);
  ...
  TResult when<TResult extends Object?>({
    ...
    return bookingService(context, totalPrice, startTime, onSuccess);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return bookingService?.call(context, totalPrice, startTime, onSuccess);
  }
...
class _$CalculateBookingImpl implements CalculateBooking {
  const _$CalculateBookingImpl(
      {required this.context, required this.startTime});
  ...
  @override
  String toString() {
    return 'BookingEvent.calculateBooking(context: $context, startTime: $startTime)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return calculateBooking(context, startTime);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return calculateBooking?.call(context, startTime);
  }
...
abstract class CalculateBooking implements BookingEvent {
  const factory CalculateBooking(
      {required final BuildContext context,
      required final DateTime startTime}) = _$CalculateBookingImpl;
...
mixin _$BookingState {
  ...
  List<EnableDate>? get listDate => throw _privateConstructorUsedError;
...
class _$BookingStateImpl implements _BookingState {
  const _$BookingStateImpl(
      ...
      final List<EnableDate>? listDate = const [],
      this.isLoading = true,
      this.coupon = null,
  ...
  final List<EnableDate>? _listDate;
  @override
  @JsonKey()
  List<EnableDate>? get listDate {
...
abstract class _BookingState implements BookingState {
  const factory _BookingState(
      ...
      final List<EnableDate>? listDate,
      final bool isLoading,
      final String? coupon,
      final bool isButtonLoading,
      final bool isPaymentLoading,
